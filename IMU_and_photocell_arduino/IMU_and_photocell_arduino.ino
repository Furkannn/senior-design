...
#define OUTPUT__MODE_CUSTOM 5 // Outputs calibrated sensor values for all 9 axes and yaw/pitc/roll values
#define OUTPUT__FORMAT_TEXT 0 // Outputs data as text
#define OUTPUT__FORMAT_BINARY 1 // Outputs data as binary float

// Select your startup output mode and format here!
int output_mode = OUTPUT__MODE_CUSTOM;
...
void loop()
{
  ...
  if((millis() - timestamp) >= OUTPUT__DATA_INTERVAL)
  {
    ...
    else if (output_mode == OUTPUT__MODE_CUSTOM) // Output sensor values
    {
      output_mode = OUTPUT__MODE_ANGLES;
      // Apply sensor calibration
      compensate_sensor_errors();
      ...
      output_mode = OUTPUT__MODE_CUSTOM;
    }
